    ...
    <div class="card">
        <form action="{{ route('admin.events.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="title" id="title" class="form-input" placeholder="e.g. Seminar Nasional Web Core & Security" required value="{{ old('title') }}">
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    <label for="type" class="form-label">Tipe Event (Factory Product)</label>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="datetime-local" name="event_date" id="event_date" class="form-input" required value="{{ old('event_date') }}">
                </div>
